...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To RYN TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}RYN TUNNELING ® ${NC}${YELLOW}(${NC} ${green} DANS STORE ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self RYN TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/jadid123/ryn.vpn/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/jadid123/backend/main/ipqu"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/jadid123/ryn.vpn/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
